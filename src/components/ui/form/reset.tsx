         ...
         <form className='flex flex-col gap-4' noValidate autoComplete='on' onSubmit={handleSubmit}>     
               ...
               <label htmlFor="password" className='flex flex-col relative'>
                  <div className='flex items-center relative'>
                     ...
                     {
                        showConfirm ? <IoEyeOutline className='translate-x-[-5%] text-[#91919F] absolute right-[5%] cursor-pointer w-4 h-4' onClick={changeShowConfirm}/> : <IoEyeOffOutline   className='translate-x-[-5%] text-[#91919F] absolute right-[5%] cursor-pointer w-4 h-4' onClick={changeShowConfirm}/>
                     }
                  </div>
                  <span className='text-[10px] max-w-[380px] px-1 pt-1 font-medium text-red-600'>{loginData.confirmPasswordError}</span>
               </label>
